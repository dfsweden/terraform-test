...
| HA network | One eth0 (data+mgmt+ha; peers discovered via cloud API) | eth0 (data/mgmt) + **eth1 on a dedicated HA subnet** — the subnet is the peer-discovery mechanism (the image's Azure provisioning has no node_index support) |
